...
# Remove old HMK 107 file
old_file = os.path.join(OUTPUT_DIR, "17 - Talep Artırım Dilekçesi (HMK 107).udf")
...
p = [
    ...
    (2, 0, "14.17", None, None, [("HMK m. 109/4 GEREĞİNCE TALEP ARTIRIMI VE TAMAMLAMA HARCI TALEBİDİR (ISLAH DEĞİLDİR)\n", True, False, False)]),
...
build_udf(p, os.path.join(OUTPUT_DIR, "17 - Talep Artırım Dilekçesi (HMK 109-4).udf"))
print("Created: 17 - Talep Artırım Dilekçesi (HMK 109-4).udf")
