...
make_template(
    ...
    "TAHLİYE TALEPLİDİR (İvedidir)",
    "Soruşturma No: 2026/... S. | Sorgu No: 2026/... D.İş (veya Esas No)",
    "ŞÜPHELİ / SANIK", "[Müvekkil Şüpheli/Sanık - T.C. 12345678901]", "[Müvekkil Adresi / Bulunduğu Ceza İnfaz Kurumu]",
    "MÜŞTEKİ / KAMU HUKUKU", "[Müşteki Adı Soyadı / K.H.]", "",
    "[..] Hâkimliği'nin / Mahkemesi'nin [..] tarihli ve [Sorgu/D.İş/Esas No] sayılı kararı ile verilen TUTUKLAMA / TUTUKLULUK HALİNİN DEVAMI KARARINA İTİRAZLARIMIZIN SUNULMASI ile tutuklama kararının kaldırılarak müvekkilin BİHAKKIN TAHLİYESİNE, Hakimliğiniz/Mahkemeniz aksi kanaatte ise CMK m. 109 uyarınca ADLİ KONTROL hükümleriyle SERBEST BIRAKILMASI talebimizdir.",
    [
        "1- MÜVEKKİLİN AŞAMALARDAKİ TUTARLI SAVUNMASI VE İŞBİRLİĞİ: Müvekkil gerek kolluk, gerek savcılık gerekse sorgu/duruşma aşamasında baştan sona samimi, istikrarlı ve maddi gerçekle örtüşen savunmalarda bulunmuştur. Adli makamların çağrısına derhal uymuş, kaçma ya da gizlenme yönünde hiçbir girişimde bulunmamış, delillerin eksiksiz toplanması adına kolluk ve yargı mercileriyle tam bir işbirliği içerisinde olmuştur.",
